...
<div class="container">
  ...
  <span class="lead"> <?php print $node->body['und']['0']['safe_summary']; ?></span>
  </div>
</div>
</div>
...
<?php $img_src = $field_image[0]['uri'];
$bgimage = file_create_url($img_src);
?>


<div class="full-width-image" style="background-image:url('<?php print($bgimage); ?>');"></div>
